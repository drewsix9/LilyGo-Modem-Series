...
void setup() {
  ...
  while (1) {
    ...
    if (modemName == "UNKNOWN") {
      ...
      break;
    } else if (modemName.startsWith("A7670E-LNXY-UBL") || modemName.startsWith("A7670E-LNMV") || modemName.startsWith("A7670SA-LASE") || modemName.startsWith("A7670SA-LASC") || modemName.startsWith("A7670G-LLSE") || modemName.startsWith("A7670G-LABE") || modemName.startsWith("A7670E-LASE ")) {
      while (1) {
