...
#define PHOTO_QUALITY 70 // JPEG quality: 0–100 (higher = better quality). Library converts to internal 1-63 scale.
                         // Old equivalent: 30 on 1-63 scale → 70 on 0-100 scale
