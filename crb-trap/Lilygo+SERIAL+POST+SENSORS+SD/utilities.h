...
// ==================== MASTER UART CONFIGURATION (Camera Serial Communication) ====================
// UART pins for SerialTransfer communication with ESP32-CAM slave camera

#define MASTER_UART_PORT Serial1     /**< HardwareSerial instance (Serial1) */
#define MASTER_UART_TX_PIN 18        /**< GPIO18 → slave RX */
#define MASTER_UART_RX_PIN 19        /**< GPIO19 ← slave TX */
#define MASTER_UART_BAUD_RATE 115200 /**< Baud rate (115200 matches slave) */
